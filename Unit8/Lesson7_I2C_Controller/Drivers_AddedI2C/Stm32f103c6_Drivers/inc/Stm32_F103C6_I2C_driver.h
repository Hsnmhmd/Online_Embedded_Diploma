...
//Slave address config structure
//-----------------------------
...
typedef struct
{
	uint32_t                                 I2C_ClockSpeed ;  //Clock frequency associated with Mode fast or standard
	                                                          //@ref I2C_SCLK_

	uint32_t                                  StretchMode ;       //Clock stretching for the slave
                                                                //@ref I2C_StrechMode

	uint32_t                                  I2C_Mode ;        //I2C OR SMBUS @ref I2C_Mode

	struct S_I2C_Slave_Device_Address         I2C_Slave_Address; //Slave Addresses

	uint32_t                           	      I2c_ACK_Control ;  //Enable or Disable ACK @ref I2C_ACK_
...
//@ref I2C_StrechMode
#define I2C_StrechMode_Enable                 0x00000000U    //CR1 //Default
